package com.example.onlineschoolcourses.ui.register.fragment.forgetPassword.viewModel
...
@HiltViewModel
class ForgetPasswordViewModel @Inject constructor(application: Application, var authRepository: AuthRepository):
