 ...
 */
public abstract class Hilt_AdditionalInformationAboutUserFragment extends BaseFragment implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AdditionalInformationAboutUserFragment_GeneratedInjector) this.generatedComponent()).injectAdditionalInformationAboutUserFragment(UnsafeCasts.<AdditionalInformationAboutUserFragment>unsafeCast(this));
    }
  }
